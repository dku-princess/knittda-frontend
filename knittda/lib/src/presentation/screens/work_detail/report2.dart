...
//   const Report2({super.key, required this.work});
//
//   @override
...
//
//     debugPrint('startDate: ${work.startDate}');
//     debugPrint('goalDate: ${work.endDate}');
...
//
//     String formattedStartDate = startDate != null ? DateUtilsHelper.toDotFormat(startDate) : '';
//     String formattedGoalDate = goalDate != null ? DateUtilsHelper.toDotFormat(goalDate) : '';
//
//     return Container(
//       width: 375,
//       height: 512,
