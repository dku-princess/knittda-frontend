...
mixin _$Article {
 ...
 int get id; String get title; String get subtitle; String get category; String get editor; String get interviewee;@JsonKey(name: 'thumbnail_image_large') String get thumbnailImageLarge;@JsonKey(name: 'thumbnail_image_small') String get thumbnailImageSmall;@JsonKey(name: 'cover_image') String? get coverImage;@JsonKey(name: 'published_at') String get publishedAt;@JsonKey(name: 'is_featured') bool get isFeatured; String get slug; String get status; List<int>? get sections;
...
@override
String toString() {
  return 'Article(id: $id, title: $title, subtitle: $subtitle, category: $category, editor: $editor, interviewee: $interviewee, thumbnailImageLarge: $thumbnailImageLarge, thumbnailImageSmall: $thumbnailImageSmall, coverImage: $coverImage, publishedAt: $publishedAt, isFeatured: $isFeatured, slug: $slug, status: $status, sections: $sections)';
}
...
class _Article implements Article {
   _Article({this.id = 0, this.title = '', this.subtitle = '', this.category = '', this.editor = '', this.interviewee = '', @JsonKey(name: 'thumbnail_image_large') this.thumbnailImageLarge = '', @JsonKey(name: 'thumbnail_image_small') this.thumbnailImageSmall = '', @JsonKey(name: 'cover_image') this.coverImage, @JsonKey(name: 'published_at') this.publishedAt = '', @JsonKey(name: 'is_featured') this.isFeatured = false, this.slug = '', this.status = '', final  List<int>? sections}): _sections = sections;
...
@override List<int>? get sections {
